...
def plot_histogram(op_df):
    ...
    fig.update_layout(paper_bgcolor="#fff", plot_bgcolor="#fff", legend_font_color="#000", font_color="#000")
    return fig
...
def plot_pie(op_df):
    ...
    fig.update_layout(width=500, height=500, paper_bgcolor="#fff", legend_font_color="#000")
